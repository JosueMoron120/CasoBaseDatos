...
public class HomeController extends HttpServlet {
	...
	int idalumnos, idescuela; String nombre,correo,telefono;
    /**
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case 6: //modificar alumno
			idalumnos = Integer.parseInt(request.getParameter("ida"));
			...
			out.println(g.toJson(ad1.update(new Alumno(idalumnos, idescuela, nombre, correo, telefono))));
			break;
		default:
			break;
		}
